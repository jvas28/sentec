...
lexicon_lines_enhance=open("../res/lexicons/ecuador_lexicon.csv","r", encoding='mbcs').readlines();

classifier_file_name="../res/training/enhanced_multiclass_classifier.pickle"
